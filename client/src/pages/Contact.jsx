...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://getform.io/f/bwnwgeqa", {
        method: "POST",
        headers: {
  ...
  const contactInfo = [
    // Contact number removed
    {
      ...
      title: "Email",
      details: [
        "enquiry.univ@ckedu.org (Official Enquiries)",
        "sahilkumarsakshi@zohomail.in (Technical Support)",
      ],
      isEmail: true,
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Have questions about our research, programs, or want to collaborate?
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="publication-inquiry">
                    Publication Inquiry
                  </option>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
              ...
              <div className="bg-gray-700/50 rounded-lg h-48 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">Interactive map updated soon</p>
